    ...
    for (const video of collectionVideos) {
      ...
      try {
        ...
        if (lesson) {
          ...
          lesson.thumbnailUrl = BunnyService.getThumbnail(video.guid, video.thumbnailFileName);
          ...
          lesson = new Lesson({
            ...
            thumbnailUrl: BunnyService.getThumbnail(video.guid, video.thumbnailFileName),
